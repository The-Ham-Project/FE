      ...
      <FooterInner>
        <Customer>
          ...
          <ul>
            <li>평일: 전체 문의 상담</li>
            <li>
              토요일, 공휴일: 오늘내집 직접배송, 이사/시공/제품설치 문의 상담
            </li>
            <li>일요일: 휴무</li>
          </ul>
          <EctCustomer>
            <Link to="#">카톡 상담(평일 09:00~18:00)</Link>
            <Link to="#">이메일 문의</Link>
          </EctCustomer>
        </Customer>
        <SectionLine />
        ...
        <Infomation>
          ...
          <SnsLink>
            ...
            <Link to="#">
              <img src={SnsIconInstagram} alt="" />
            </Link>
            <Link to="#">
              <img src={SnsIconFacebook} alt="" />
            </Link>
            <Link to="#">
              <img src={SnsIconKakaoStory} alt="" />
            </Link>
            <Link to="#">
              <img src={SnsIconNaverPost} alt="" />
            </Link>
          </SnsLink>
          <Copyright>
